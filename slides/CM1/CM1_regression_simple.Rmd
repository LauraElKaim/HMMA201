...
* Moodle  
https://moodle.umontpellier.fr/course/view.php?id=1509

## GitHub  HMMA201

* https://github.com/pbastide/HMMA201
...
and $s_{\mathbf{y},\mathbf{x}}^2 = \sum_{i = 1}^n (x_i - \bar{x})(y_i - \bar{y})$  
the empirical variance and covariance of $\mathbf{x}$ and $\mathbf{y}$.

<!-- ************************************************************************ -->
# OLS estimators are unbiaised
<!-- ************************************************************************ -->
...
$$
\mathbb{E}[\hat{\beta}_0] = \beta_0 \qquad \mathbb{E}[\hat{\beta}_0] = \beta_1
$$
</div>

## The OLS estimators are unbiaised
...
## OLS is unbiaised - Proof 2/4 {.build}
...
&= \mathbb{E}\left[\sum_{i = 1}^n q_i y_i\right] = \cdots = \beta_1 & \text{(unbiaised)}
\end{aligned}
$$
...
\beta_1 &= \beta_0 \sum_{i = 1}^n q_i + \beta_1 \sum_{i = 1}^n q_ix_i  & \text{(unbiaised)}
\end{aligned}
$$
...
>* Let's show that $\mathbb{Var}[\tilde{\beta}_1] > \mathbb{Var}[\hat{\beta}_1]$
